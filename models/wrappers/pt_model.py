...
import models.wrappers.utils as utils
from cyclops.utils.file import join
from cyclops.utils.log import setup_logging
from models.data import PTDataset
from models.utils import LossMeter, get_module, is_pytorch_instance, is_pytorch_model
from models.wrappers.base import ModelWrapper
from models.wrappers.utils import check_is_fitted, to_numpy, to_tensor
...
class PTModel(ModelWrapper):
    ...
    def __init__(  # pylint: disable=too-many-arguments
        ...
        save_every: int = -1,  # if -1, save only latest model
    ...
    def _train_step(self, batch, **fit_params) -> Dict[str, torch.Tensor]:
        ...
        **fit_params : dict, optional
        ...
        # update learning rate, if step-based scheduler is used
