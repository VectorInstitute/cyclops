...
def synthetic_gemini_dataset(size=1000):
    ...
    gemini_mapping = OmegaConf.load("drift_detection/datasets/configs/gemini.yaml").gemini_mapping
    ...
    df['admit_timestamp'] = pd.date_range(start='1/1/2015', end='8/1/2020', periods=size)
    df['discharge_timestamp'] = pd.date_range(start='1/1/2015', end='8/1/2020', periods=size)
