    ...
    for graph_type in graph_type_list:
        for mi in mi_list:
            ...
            for random_seed in random_seed_list:
                ...
                print(
                    f"Starting: {experiment} on {graph_type} \
                    graph with {mi} MI and {random_seed} as the random seed"
                )
                ...
                ###########################################################
                # since we are using data always drawn
                # from the same distribution we only need to fit once
            ...
            plot_title = f"Detection for {experiment} on \
                    {graph_type} graph with {mi} MI"
            # Uncomment below if you would like a detection
            # confusion matrix plotted for each experiment
            ...
            print(
                f'Micro-precision: \
                {localization_metrics["micro-precision"]:.3f};'
                + f' Micro-recall: \
                {localization_metrics["micro-recall"]:.3f}'
            )
            # saving results
            experiment_results = {
