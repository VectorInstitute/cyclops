"""Define Gaussian Density Estimation models for FSD."""
import numpy as np
import torch
...
class GaussianDensity:
    ...
    def conditional_sample(self, x, feature_idx, n_samples=1, random_state=None):
        """Compute the conditional distribution of the jth feature of the density.

        Computes the conditional distribution of the jth feature of the density
        and samples from the conditional distribution.
    ...
    def _calculate_1d_guassian_conditional(
        ...
        """Compute the conditional distribution of the ith feature of the density.
...
class DeepDensity:
    ...
    def log_prob(self, X):
        """Compute and the log-probability of the samples.
...
class Knn:
    """Use Sklearn's NearestNeighbors class.
