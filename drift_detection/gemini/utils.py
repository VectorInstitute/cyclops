...
def apply_predefined_shift(
    experimenter, X_s_orig, y_s_orig, X_te_orig, y_te_orig, shift, tol_var="gender"
):
    ...
    if shift == "large_gn_shift_1.0":
        ...
        X_te_1, _ = experimenter.tolerance(
            X_s_orig, y_s_orig, X_te_orig, y_te_orig, tol_var
        )
        y_te_1 = y_te_orig.copy()
    else:
        raise ValueError(
            "Not a pre-defined shift, specify custom parameters using appropriate function"
        )
