...
TOPS = [
    "access lines - invasive - arterial line dressing occlusive",
    ...
    "alarms - parameters checked",
    "alarms - resp alarm - high",
    "alarms - resp alarm - low",
    "alarms - spo2 desat limit",
    "alarms - st segment monitoring on",
    "hemodynamics - central venous pressure",
    "labs - anion gap",
    ...
    "treatments - activity / mobility",
    "treatments - eye care",
    "treatments - subglottal suctioning",
]
