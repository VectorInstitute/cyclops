...
function updatePlot() {
  ...
  const inputs = document.querySelectorAll('#slice-selection input[type="radio"]:checked, [id^="slice-selection"] input[type="radio"]:checked');
  ...
  if (plot_selected.value === "+") {
      ...
      // Add Bootstrap classes to match other radio buttons
      new_plot.classList.add('btn-check');
      new_label.classList.add('btn', 'btn-outline-primary', 'm-1');

      // Set attributes for proper Bootstrap styling
      new_plot.setAttribute('autocomplete', 'off');
      new_label.setAttribute('for', new_plot.id);
...
function updatePlotSelection() {
  ...
  if (plot_selected.value === "+") {
      ...
      // Add Bootstrap classes to match other radio buttons
      new_plot.classList.add('btn-check');
      new_label.classList.add('btn', 'btn-outline-primary');
      ...
      new_label.style.padding = "2.5px 0px"; // padding top and bottom 5px, padding left and right 0px
