...
from cyclops.evaluation.metrics.functional.precision_recall_curve import (
...
from cyclops.evaluation.metrics.utils import _check_thresholds
...
def _roc_compute_from_confmat(
    ...
    ----------
        ...
        thresholds : np.ndarray of floats, default=None
...
def roc_curve(  # pylint: disable=too-many-arguments
    ...
    ----------
        ...
        thresholds : int or list of floats or np.ndarray of floats, default=None
            ...
            into a numpy array.
            - np.ndarray of floats: use the values in the array as thresholds. The
...
def binary_roc_curve(
    ...
    target, preds, thresholds = _binary_precision_recall_curve_format(
        target, preds, thresholds
    )
...
def multiclass_roc_curve(
    ...
    target, preds, thresholds = _multiclass_precision_recall_curve_format(
...
def multilabel_roc_curve(
    ...
    target, preds, thresholds = _multilabel_precision_recall_curve_format(
